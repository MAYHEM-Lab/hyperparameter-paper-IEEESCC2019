...
\hyphenation{Dev-Ops}
\hyphenation{hyper-parameter}
\hyphenation{hyper-parameterization}
\hyphenation{exe-cution}
\hyphenation{Celery}
\hyphenation{app-lication}
\hyphenation{classi-fication} 
\hyphenation{ex-ploration}
\hyphenation{models}
\hyphenation{machine}
...
\title{Seneca: Low Cost and Fast 
Hyperparameter Search and Selection for Machine Learning Models}
...
%\author{\IEEEauthorblockN{Michael Zhang, Chandra Krintz, Rich Wolski, Markus Mock}
