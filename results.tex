...
The classification applications compute a classification accuracy score
...
have verified that the optimized allocated memory allows all 
hyperparameter settings complete successfully.
...
% To do so, we use Seneca to find the hyperparameterization that optimizes application output
